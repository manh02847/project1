...
2. Nếu thông tin SQL Server khác, sửa `ConnectionStrings:DefaultConnection` trong `NguyenNgocManh2410900051/appsettings.json`. Mặc định đang dùng SQL Server tại `localhost`, tài khoản `sa`, mật khẩu mẫu `Exam!2410900051`.
